<div class="modal hide fade" id="register">
				...
				<div class="modal-body" data-backdrop="static">
									...
									<div class="controls">
										<div class="alert alert-info">
											<label for="u_fname" class="control-label">注册账号</label> <input
												type="text" id="u_fname" name="reusername" onblur="checkUser(this)"
												class="input-xlarge" value="" /> <strong>账号*</strong>
											请认真填写！
										</div>
					...
					<div class="modal-footer">
						<button id="reg" class="btn btn-inverse pull-right" type="button"
